      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-10 lg:gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-gray-400 mb-7 sm:mb-8 max-w-2xl"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-400 justify-start"
          >
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -right-4 top-20 glass-card px-4 py-3 rounded-2xl shadow-lg backdrop-blur-sm"
            >
