        ...
        <AnimatePresence>
          {showToast && (
            <motion.div
              ...
              className="pointer-events-auto flex items-center gap-3 bg-neutral-900/90 border border-white/10 text-white px-5 py-4 rounded-2xl shadow-2xl backdrop-blur-md max-w-sm w-full sm:w-auto"
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  Locafii is currently in review for iOS. Stay tuned!
                </p>
              </div>
        ...
        >
          ...
          <div className="glass-card rounded-[2.5rem] sm:rounded-[3rem] p-6 sm:p-10 md:p-16 text-left md:text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              >
                Join millions of families who trust Locafii for real-time location
                sharing and peace of mind. Download now and start tracking in 2
                minutes.
              </motion.p>
              ...
              >
                <span className="flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-[#56FBAC] shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <span className="flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-[#616083] shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
